  ...
  const socialLinks = [
    {
      ...
      label: "GitHub",
      url: "https://github.com/Teja78906",
      color: "#FF6B6B",
    },
    {
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          >
            I'm always open to new opportunities, innovative collaborations, or
            meaningful conversations around AI, blockchain, and cybersecurity.
          </p>
        </div>
            ...
            >
              ...
              <CardContent className="p-6 md:p-8 flex flex-col h-[calc(100%-8px)] mt-2">
                ...
                >
                  ...
                  the latest in Blockchain, Cyber security and cloud technologies.
                </p>
        ...
        >
          ...
          <p style={{ color: theme.palette.text.secondary }}>
            © {new Date().getFullYear()} Allu Teja Swaroop. All rights reserved.
          </p>
        </div>
      </div>
    </section>
